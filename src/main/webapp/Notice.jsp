...
<head>
    ...
    <title>Student Management System - Notices</title>
    ...
    <main class="content">
        ...
        <section class="container-fluid p-4">
            <div class="dashboard-welcome text-center">
                <h2>Your Notices Overview</h2>
                <p>Select an option from the menu to view the latest notices.</p>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <!-- Example notice records -->
                            <tr>
                                <td>December 1, 2024</td>
                                <td>End of Semester Exams</td>
                                <td>The end of semester exams will commence on December 15, 2024.</td>
                            </tr>
                            <tr>
                                <td>December 2, 2024</td>
                                <td>Library Closure Notice</td>
                                <td>The library will be closed for maintenance on December 10, 2024.</td>
                            </tr>
