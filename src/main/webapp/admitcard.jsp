...
<head>
    ...
    <title>Student Management System - Admit Card</title>
    ...
    <main class="content">
        ...
        <section class="container-fluid p-4">
            <div class="dashboard-welcome text-center">
                ...
                <p>Select an option from the menu to view your admit card details.</p>
            </div>

            <div class="card">
                <div class="card-header">
                    <h5>Your Admit Card Information</h5>
                </div>
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Exam Date</td>
                                <td><%= request.getAttribute("examDate") %></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
