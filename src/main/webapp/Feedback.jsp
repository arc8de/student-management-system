...
<head>
    ...
    <title>Student Management System - Feedback</title>
    ...
    <main class="content">
        ...
        <section class="container-fluid p-4">
            <div class="dashboard-welcome text-center">
                <h2>Your Feedback Overview</h2>
                <p>Select an option from the menu to view or submit your feedback.</p>
            </div>

            <!-- Feedback Section -->
            <div class="card">
                <div class="card-header">
                    <h5>Your Feedback Records</h5>
                </div>
                <div class="card-body">
                    <!-- Example feedback details -->
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Great course! Very informative.</td>
                            </tr>
                            <tr>
                                <td>December 2, 2024</td>
                                <td>Instructor Feedback</td>
                                <td>The instructor was very helpful.</td>
                            </tr>
                    ...
                    <form action="#" method="POST" id="feedbackForm">
                        <div class="mb-3">
                            ...
                            <select id="feedbackType" name="feedbackType" required class="form-select">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="comments" name="comments" rows="4" required class="form-control"></textarea>
                        </div>
