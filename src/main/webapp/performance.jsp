...
<head>
    ...
    <title>Student Management System - Performance</title>
...
" href="#" data-bs-toggle="modal" data-bs-target="#changePasswordModal"><i class="fas fa-key me-2"></i>Change Password</a></li>
        ...
        <section class="container-fluid p-4">
            <div class="dashboard-welcome text-center">
                ...
                <p>Select an option from the menu to view your performance details.</p>
            </div>

            <!-- Performance Section -->
            <div class="card">
                <div class="card-header">
                    <h5>Your Performance Records</h5>
                </div>
                <div class="card-body">
                    <!-- Example performance details -->
