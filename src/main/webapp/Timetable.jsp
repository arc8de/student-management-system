...
<head>
    ...
    <title>Student Management System - Timetable</title>
    ...
    <main class="content">
        ...
        <section class="container-fluid p-4">
            <div class="dashboard-welcome text-center">
                <h2>Your Timetable Overview</h2>
                <p>Select an option from the menu to view your timetable details.</p>
            </div>

            <!-- Timetable Section -->
            <div class="card">
                <div class="card-header">
                    <h5>Your Timetable Records</h5>
                </div>
                <div class="card-body">
                    <!-- Example timetable details -->
