...
<head>
    ...
    <title>Student Management System - College Info</title>
                    ...
                    <div class="ms-auto">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item ```jsp
" href="#" data-bs-toggle="modal" data-bs-target="#changePasswordModal"><i class="fas fa-key me-2"></i>Change Password</a></li>
        ...
        <section class="container-fluid p-4">
            <div class="dashboard-welcome text-center">
                <h2>College Information Overview</h2>
                <p>Select an option from the menu to view college details.</p>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Example college information -->
                    <p><strong>Name:</strong> XYZ College of Engineering</p>
                    <p><strong>Established:</strong> 1995</p>
                    <p><strong>Location:</strong> City Center, State, Country</p>
                    ...
                    <p><strong>Email:</strong> info@xyzcollege.edu</p>
                    ...
                    <ul>
                        ...
                        <li>Modern laboratories and workshops</li>
