    ...
    <main class="content">
        ...
        <section class="container-fluid p-4">
            <div class="dashboard-welcome text-center">
                <h2>Computer Science Courses Overview</h2>
                <p>Select a course from the menu to view details.</p>
            </div>

            <!-- Courses Section -->
            <div class="card">
                <div class="card-header">
                    <h5>Your Computer Science Courses</h5>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>An introduction to data structures and algorithms.</td>
                            </tr>
                            <tr>
                                <td>Operating Systems</td>
                                <td>A study of operating system concepts and design.</td>
                            </tr>
                            <tr>
                                <td>Database Management Systems</td>
                                <td>An overview of database design and management.</td>
                            </tr>
